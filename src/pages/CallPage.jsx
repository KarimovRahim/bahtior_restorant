...
// Карточка филиала (мобильная)
const BranchCard = ({ branch, index, isVisible, copiedPhone, onCopy, onCall, onNavigate }) => {
    ...
    >
      <div className='p-5'>
        ...
        <div className='flex gap-2'>
          ...
          <button
            onClick={() => onNavigate(branch.mapUrl)}
...
// Карточка филиала (десктоп)
const DesktopBranchCard = ({ branch, index, copiedPhone, onCopy, onCall, onNavigate }) => {
  const [isHovered, setIsHovered] = useState(false)
