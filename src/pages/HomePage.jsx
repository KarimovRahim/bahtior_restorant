...
const HomePage = () => {
  ...
  useEffect(() => {
    setIsVisible(true);
    // Генерируем плавающие элементы для десктопа
    setFloatingElements([
    ...
    >
      ...
      <div className="flex-1 w-full h-full flex flex-col lg:flex-row overflow-hidden relative z-10">
        ...
        <div className="lg:hidden w-full h-full flex flex-col px-4 py-3 overflow-y-auto">
          ...
          >
            <div className="w-13 h-13 rounded-xl overflow-hidden flex-shrink-0 relative"
                 style={{ boxShadow: 'var(--shadow-gold)', border: '1.5px solid var(--accent-gold)', padding: '2px', background: 'var(--bg-card)' }}>
              <img src={LOGO_PATH} alt="Бахтиёр" className="w-full h-full object-cover rounded-lg" />
            </div>

            <div className="text-center flex-1">
              <h1 className="text-xl font-serif font-bold tracking-tight"
                  style={{ background: 'linear-gradient(135deg, var(--text-primary) 0%, var(--accent-gold) 50%, var(--text-secondary) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                BAXTIYOR
              </h1>
              <div className="flex items-center justify-center gap-2">
                <span className="text-[8px] tracking-[.25em] font-semibold" style={{ color: 'var(--accent-gold)' }}>RESTAURANT</span>
                <span className="text-[6px]" style={{ color: 'var(--accent-gold)', opacity: 0.6 }}>✦</span>
                <span className="text-[8px] tracking-[.25em] font-semibold" style={{ color: 'var(--accent-gold)' }}>РЕСТОРАН</span>
              </div>
            </div>

            <button onClick={toggleTheme}
                    className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: 'var(--toggle-bg)', color: 'var(--toggle-text)', boxShadow: 'var(--shadow-sm)', border: '1px solid var(--border-color)' }}>
          ...
          <div className={`text-center mt-2 mb-4 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="inline-block px-4 py-2 rounded-full"
                 style={{ background: 'linear-gradient(135deg, var(--bg-card) 0%, transparent 100%)', border: '1px solid var(--border-color)' }}>
              <p className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>Восточное гостеприимство и уют</p>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col justify-center">
            <div className="space-y-2">
              {menuItems.map((item, index) => (
                <MobileCard key={index} item={item} index={index} hoveredIndex={hoveredIndex} setHoveredIndex={setHoveredIndex} isVisible={isVisible} />
              ))}
            </div>
          </div>
          ...
          <div className={`text-center pt-3 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <p className="text-[9px] uppercase tracking-[.35em] font-medium" style={{ color: 'var(--accent-gold)', opacity: 0.4 }}>#БАХТИЁР</p>
          </div>
        </div>
          ...
          <div className="w-1/3 flex flex-col justify-center pr-8">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
              ...
              <div className="relative mb-8 group">
                <div className="absolute -inset-4 rounded-3xl opacity-0 group-hover:opacity-100 transition-all duration-700 blur-xl"
                     style={{ background: 'radial-gradient(circle, var(--accent-gold) 0%, transparent 70%)' }} />
                <div className="w-32 h-30 rounded-2xl overflow-hidden relative mx-auto"
                     style={{ boxShadow: 'var(--shadow-gold)', border: '2px solid var(--accent-gold)' }}>
              ...
              <h1 className="text-5xl font-serif font-bold text-center mb-4"
                  style={{ background: 'linear-gradient(135deg, var(--text-primary) 0%, var(--accent-gold) 50%, var(--text-secondary) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', animation: 'shimmer 3s ease-in-out infinite' }}>
                BAXTIYOR
              </h1>

              <div className="flex items-center justify-center gap-3 mb-6">
                <span className="text-xs tracking-[.3em] font-semibold" style={{ color: 'var(--accent-gold)' }}>RESTAURANT</span>
                <Sparkles size={12} style={{ color: 'var(--accent-gold)', animation: 'pulse 2s ease-in-out infinite' }} />
                <span className="text-xs tracking-[.3em] font-semibold" style={{ color: 'var(--accent-gold)' }}>РЕСТОРАН</span>
              </div>

{/* Описание с иконками */}
<div className="space-y-4">
  <div className="group flex items-center gap-3 p-3 rounded-xl transition-all duration-500 cursor-pointer hover:scale-[1.02]"
       style={{ 
    ...
    <Crown size={20} className="transition-all duration-500 group-hover:scale-110" style={{ color: 'var(--accent-gold)' }} />
    <span className="transition-all duration-500 group-hover:translate-x-1" style={{ color: 'var(--text-secondary)' }}>Восточное гостеприимство</span>
  </div>
  ...
  <div className="group flex items-center gap-3 p-3 rounded-xl transition-all duration-500 cursor-pointer hover:scale-[1.02]"
    ...
    <Heart size={20} className="transition-all duration-500 group-hover:scale-110" style={{ color: 'var(--accent-gold)', animation: 'heartbeat 2s ease-in-out infinite' }} />
    <span className="transition-all duration-500 group-hover:translate-x-1" style={{ color: 'var(--text-secondary)' }}>Уютная атмосфера</span>
  </div>
  ...
  <div className="group flex items-center gap-3 p-3 rounded-xl transition-all duration-500 cursor-pointer hover:scale-[1.02]"
    ...
    <Clock size={20} className="transition-all duration-500 group-hover:scale-110" style={{ color: 'var(--accent-gold)' }} />
    <span className="transition-all duration-500 group-hover:translate-x-1" style={{ color: 'var(--text-secondary)' }}>Свежие продукты</span>
  </div>
</div>
              ...
              <button onClick={toggleTheme}
                      ...
                      style={{ backgroundColor: 'var(--toggle-bg)', color: 'var(--toggle-text)', border: '1px solid var(--border-color)' }}>
          ...
          <div className="w-2/3 flex items-center pl-8">
            <div className={`w-full transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
              <div className="grid grid-cols-2 gap-4">
                {menuItems.map((item, index) => (
                  <DesktopCard key={index} item={item} index={index} hoveredIndex={hoveredIndex} setHoveredIndex={setHoveredIndex} />
                ))}
              </div>
            </div>
          </div>
...
// Компонент карточки для мобильной версии — УСИЛЕННЫЙ HOVER
const MobileCard = ({ item, index, hoveredIndex, setHoveredIndex, isVisible }) => (
  <button
    onClick={item.action}
    onMouseEnter={() => setHoveredIndex(index)}
    onMouseLeave={() => setHoveredIndex(null)}
    className={`w-full flex items-center justify-between py-3 px-4 rounded-xl transition-all duration-500 group relative overflow-hidden
  ...
  >
    ...
    <div className="absolute inset-0 opacity-[0.02] group-hover:opacity-[0.08] transition-all duration-700"
    ...
    <div className="absolute bottom-0 left-0 right-0 h-px opacity-0 group-hover:opacity-100 transition-all duration-500"
         style={{ background: 'linear-gradient(90deg, transparent, var(--accent-gold), transparent)' }} />
    ...
    <div className="flex items-center gap-4 relative z-10">
      ...
      <div className="text-left">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[9px] px-1.5 py-0.5 rounded-full transition-all duration-500"
                style={{ 
        ...
        <div className="text-[11px] font-medium transition-all duration-500"
             style={{ 
    ...
    <div className="absolute right-0 bottom-0 transition-all duration-500"
         style={{ 
...
// Компонент карточки для десктопной версии — УСИЛЕННЫЙ HOVER
const DesktopCard = ({ item, index, hoveredIndex, setHoveredIndex }) => (
  <button
    onClick={item.action}
    onMouseEnter={() => setHoveredIndex(index)}
    onMouseLeave={() => setHoveredIndex(null)}
    ...
    <div className="relative z-10">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="p-3 rounded-xl transition-all duration-500"
          ...
          <item.icon size={hoveredIndex === index ? 32 : 28} strokeWidth={1.5}
                    style={{ color: hoveredIndex === index ? 'var(--accent-gold)' : 'var(--icon-color)' }} />
        </div>
        <span className="text-xs px-2 py-1 rounded-full font-bold transition-all duration-500"
              style={{ 
                background: hoveredIndex === index ? 'var(--accent-gold)' : 'var(--accent-gold)80', 
                color: 'white', 
      ...
      <p className="text-sm font-medium mb-1 transition-all duration-500"
         style={{ 
